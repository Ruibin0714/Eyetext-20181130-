...
namespace EyesManager
{
    public class IniManager : IDisposable
    {
        ...
        [DllImport("kernel32")]
        private static extern int GetPrivateProfileString(int section, string key, string def, [MarshalAs(UnmanagedType.LPArray)] byte[] result, int size, string filePath);
